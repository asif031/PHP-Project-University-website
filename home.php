...
include "header1.php";
  ...
  <marquee width="60%" loop="10" bgcolor=" #8ce1d1 " direction="left" onmouseover="this.stop()"  onmouseout="this.start()" scrollamount="2">Welcome to Ainz Ooal Gown University of Nazarick. This is the official website of AOG University. This is the place where your dream comes true...</marquee><br>
