...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($student_name) && !empty($password) && !empty($student_id) && !empty($cgpa) && !empty($dept_id))
		{

			//save to database
			$query = "insert into students (student_id, dept_id,student_name,password, cgpa) values ('$student_id','$dept_id','$student_name','$password','$cgpa')";
